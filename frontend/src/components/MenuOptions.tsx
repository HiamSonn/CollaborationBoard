...
export function MenuOptions() {
  return (
    <div className={styles.container}>
      ...
      <button
        onClick={async () => {
          ...
          if (fontSize) {
            createNewNode(
              "text",
              { text: "Default text...", fontSize: fontSize },
              3500
            );
          }
        }}
      ...
      >
        <Image src="/icons/text.svg" alt="Text icon" width={24} height={24} />
      </button>
      <button
        onClick={() =>
          createNewNode("divider", { width: 5, height: 150, rotation: 0 }, 100)
        }
      ...
      >
        <Image src="/icons/image.png" alt="Image icon" width={24} height={24} />
      </button>
    </div>
  );
}
